...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <section class="text-center max-w-3xl mx-auto mb-12 p-4 bg-gray-100 text-bold shadow">
        ...
        <p class="text-lg text-gray-600 text-justify font-serif leading-relaxed mb-6">
            pour le faire , des société ont créé ces itineraire pour vous , si vous désirez voyage sur certaines lieux touristique , veilez cliquer sur ce lien pour voir l'itinéraire que vous pouvez participer
        </p>
